...
export default function HeroSection() {
    return (
        <div className="relative h-screen w-auto p-5 flex flex-col gap-[100px]">
            ...
            <BoxReveal boxColor="#10b981">
                <div className="text-7xl text-white w-[50%]">Explore, discover, and connect with potential people from all over the world</div>
            </BoxReveal>
